...
|-----------|----------|----------|
| Architecture & design | Batman | System design, tech decisions, spec review |
| PDF extraction & OCR | Wonder-Woman | pdf_extractor.py, ocr_service.py, Azure Functions |
| HTML output & templates | Flash | html_builder.py, CSS, HTML rendering, UI quality |
| Infrastructure & CI/CD | Cyborg | Azure deployment, GitHub Actions, host.json, requirements.txt |
| Code review | Batman | Review PRs, check quality, suggest improvements |
| Testing | Aquaman | Write tests, find edge cases, verify fixes |
| Scope & priorities | Batman | What to build next, trade-offs, decisions |
